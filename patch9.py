#!/usr/bin/env python3
"""patch9.py — AI fish species identification via Claude API"""
...
print("=== patch9: AI fish species identification ===")

# ─────────────────────────────────────────────────────────────────────────────
# C1: Add identifying + identifyResult state after photo state
# ─────────────────────────────────────────────────────────────────────────────
rep(
    ...
    "C1-add-identify-state"
)

# ─────────────────────────────────────────────────────────────────────────────
# C2: Modify handlePhoto to call identifyFish after setPhoto
# ─────────────────────────────────────────────────────────────────────────────
rep(
    ...
    "C2-handlePhoto-call-identifyFish"
)

# ─────────────────────────────────────────────────────────────────────────────
# C3: Add identifyFish function after handlePhoto
# ─────────────────────────────────────────────────────────────────────────────
rep(
    "  const handleSave = () => {\n"
    "    onSave({ species, length, weight, date: new Date(date).getTime(), location, notes, photo });\n"
    "  };",
    ...
    "C3-add-identifyFish-fn"
)

# ─────────────────────────────────────────────────────────────────────────────
# C4: Expose LOG_SPECIES globally so identifyFish can access it
# ─────────────────────────────────────────────────────────────────────────────
rep(
    "const LOG_SPECIES = [",
    "const LOG_SPECIES = window.TL_LOG_SPECIES = [",
    "C4-expose-LOG_SPECIES"
)

# ─────────────────────────────────────────────────────────────────────────────
# C5: Update photo UI — show identifying spinner and result badge
# ─────────────────────────────────────────────────────────────────────────────
rep(
    "          {photo\n"
    ...
    "C5-photo-ui-with-identify"
)

# ─────────────────────────────────────────────────────────────────────────────
# C6: Add spin keyframe if not already present (add to existing @keyframes block)
# ─────────────────────────────────────────────────────────────────────────────
if '@keyframes tl-spin' not in src:
    rep(
    ...
    print("  ✓ C6-spin-keyframe (already present)")
    changes.append("C6-spin-keyframe-skipped")

# ─────────────────────────────────────────────────────────────────────────────
# S1: Add Claude API key section in Settings before the version footer
# ─────────────────────────────────────────────────────────────────────────────
rep(
    ...
    "S1-settings-ai-section"
)

# ─────────────────────────────────────────────────────────────────────────────
# S2: Add ApiKeyInput component before Settings function
# ─────────────────────────────────────────────────────────────────────────────
rep(
